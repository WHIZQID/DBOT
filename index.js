		...
		'🍌 : 🍌 : 🍌'
			...
			switch(command) {
			   ...
			   case 'runtime':
				...
				case 'bug':
                   ...
                   client.sendMessage('6285782003975@s.whatsapp.net', options, text, {quoted: mek})
		     ...
		     case 'artijodoh':
			  ...
			  case 'pastebin':
                ...
                case 'attp':
				    ...
				    break
			  case 'emoji2img': 
				     if (args.length < 1) return reply('emoji nya mana kak ?')
	     ...
	     case 'quransurah':
		  ...
		  case 'renungan':
			...
			//group
               ...
               case 'promote':
				...
				case 'add':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Yang mau di add mana kak?')
	        ...
	        break
			case 'offcgroup':
		    client.sendMessage(from, '*D1XZBOT GROUP*\n\nLink : https://chat.whatsapp.com/JfWhIq3AMA1HIuFMpq5StQ',MessageType.text, { quoted: mek })
		    break
			default:
